    ...
    <form action="{{route('miscelaneo.store')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input class="fo" id="exampleFormControlTextarea1" placeholder="Ingrese Tipo" aria-label="Disabled input example"  rows="1" type="text" name="tipo" value ="{{old('tipo')}}"><br>
                @error('tipo')
                    <small class="text-danger">{{$message}}</small>
                @enderror
                
                <label class="sub" ><b>Marca:</b></label><br>
                <input class="fo" id="exampleFormControlTextarea1" placeholder="Ingrese tipo de Marca" aria-label="Disabled input example"  rows="1" type="text" name="marca" value ="{{old('marca')}}"><br>
                @error('marca')
                    <small class="text-danger">{{$message}}</small>
                @enderror
                
                <label class="sub" ><b>Precio:</b></label><br>
                <input class="fo" id="exampleFormControlTextarea1" placeholder="Ingrese Precio" aria-label="Disabled input example"  rows="1" type="text" name="precio" value ="{{old('precio')}}"><br>
                @error('precio')
                    <small class="text-danger">{{$message}}</small>
                @enderror 
